...
public class CommandProcessor implements Callable<Integer> {
    ...
    private void processUser(Scanner scanner, Context context) {
        ...
        printer.info("| └-list | Показать отчет по кошельку           |");
        printer.info("|category| Категория расходов                   |");
        printer.info("| ├-add  | Положить деньги в кошелек            |");
        printer.info("| ├-edit | Положить деньги в кошелек            |");
        printer.info("| └-list | Взять деньги из кошелька             |");
