...
class BishopTest {
    ...
    void moveTest1(int startLine, int startColumn, int endLine, int endColumn, boolean canMove) {
        board.getBoard()[0][0] = new Bishop(WHITE);
        board.getBoard()[0][1] = new Bishop(WHITE);
        board.getBoard()[1][0] = new Bishop(WHITE);
        board.getBoard()[1][1] = new Bishop(WHITE);
    ...
    void moveTest2(int startLine, int startColumn, int endLine, int endColumn, boolean canMove) {
        board.getBoard()[5][5] = new Bishop(WHITE);
        board.getBoard()[7][7] = new Bishop(WHITE);
    ...
    void attackTest2(int startLine, int startColumn, int endLine, int endColumn, boolean canMove) {
        board.getBoard()[0][0] = new Bishop(WHITE);
        board.getBoard()[5][5] = new Bishop(WHITE);
        board.getBoard()[7][7] = new Bishop(BLACK);
